...
Las skills del producto en su versión **cascarón**:

**Grupo A:** dictaminador-cfdi · calculadora-nomina-mx (piloto) · regimen-fiscal-optimo · calculadora-actualizacion-recargos · conciliador-imss-infonavit
...
- `dictaminador-cfdi/` — validación de CFDI 4.0 con catálogos del Anexo 20, reglas de consistencia y **listas 69/69-B/69-B Bis/49 Bis verificadas en vivo** con fecha de corte (datos 100% del backend)
- `conciliador-imss-infonavit/` — concilia EMA y EBA contra la determinación del SUA, con la causa de cada diferencia y su fundamento (cálculo 100% en el backend)
