# Plantilla — Formato de Solicitud ARCO

> Formato que el Responsable pone a disposición del Titular para que ejerza sus derechos de Acceso, Rectificación, Cancelación u Oposición conforme al Art. 29 LFPDPPP.
...
| Domicilio para recibir notificaciones | _____________________________________________ |
...
## 2. Representación (si aplica)

*Si el Titular actúa por medio de representante, completar esta sección.*
...
## 3. Derecho que se ejerce

Marque con una "X" el derecho que desea ejercer (puede ser más de uno):
...
- ¿En qué área u oficina cree que están sus datos? _______________

---

## 5. Detalles según el derecho ejercido

**Si es Rectificación:**

| Dato actual (incorrecto) | Dato correcto |
|--------------------------|---------------|
|                          |               |
|                          |               |
...
## 6. Medio para recibir respuesta

Indique cómo desea recibir la respuesta del Responsable:

[ ] Correo electrónico indicado en la Sección 1
[ ] Correo postal al domicilio indicado en la Sección 1
[ ] Presencial en las oficinas del Responsable
[ ] Otro: _______________________________

---

## 7. Documentos que adjunto

[ ] Copia de identificación oficial vigente del Titular
[ ] Copia de identificación del representante (si aplica)
[ ] Documento que acredita la personalidad del representante (si aplica)
[ ] Documentos que sustentan la rectificación solicitada (si aplica)
...
| Folio asignado | _______________ |
| Quien recibió | _______________ |
| Documentos completos | [ ] Sí  [ ] No (especificar lo que falta): _______________ |
| Plazo de respuesta vence el | _______________ |
